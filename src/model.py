...
CONV1_FILTERS = 16 #number of KERNEL_SIZE x KERNEL_SIZE x INPUT_CHANNEL(RGB) filters, here  3x3x3 = 27 learnable weights
CONV2_FILTERS = 32 
FC1_SIZE = 128 #number of neurons in first linear layer, inputs to it would be CONV2_FILTERS x 8 x 8 , here 8 comes after pooling 2 times, 32(CONV1_FILTERS) / 2 then / 2 = 8 therefore 2048 inputs
